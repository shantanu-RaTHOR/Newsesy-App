...
class CustomCategory(var customcategory:String): Fragment(), Myadapter.OnNewsItemClickListener,AdapterStragged.OnNewsItemClickListener {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_customcategory, container, false)
        ...
        viewModel!!.searchNews(customcategory)
